...
class IVFURoundtableEvent(form.Schema):
    ...
    workshops = schema.Text(title=_(u"Workshops"), description=_(u"One per line. Format: number|name. For example: 1|Workshop1"), required=False)
    workshops_description = schema.Text(title=_(u"Description for workshops"), description=_(u"One per line"), required=False)
